...
public class McpServerRepository
{
    ...
    @Inject
    private McpServerBuiltins mcpBuiltins;
    ...
    {
        String serversJson = getPreferenceStore().getString( PreferenceConstants.ECLIPSECTL_DEFINED_MCP_SERVERS );
    ...
    public void save( List<McpServerDescriptor> servers )
    {
        ...
        getPreferenceStore().setValue( PreferenceConstants.ECLIPSECTL_DEFINED_MCP_SERVERS, json );
        logger.info( "MCP Servers Updated" );
    }

    public void setToDefault()
    {
        getPreferenceStore().setToDefault( PreferenceConstants.ECLIPSECTL_DEFINED_MCP_SERVERS );
